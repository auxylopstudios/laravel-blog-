    ...
    <section id="posts-list">
        <div class="uk-panel uk-panel-box uk-panel-box-secondary posts">
            ...
            <div id="switch-from-content" class="uk-switcher">
                {!! Form::model($profile,['route'=>['profile.update',$profile->id],'method'=>'PUT','class'=>'uk-form']) !!}
                ...
                <div class="uk-form-row">
                    {{Form::submit('Update',['class'=>'uk-form-control uk-button uk-button-large uk-button-primary'])}}
